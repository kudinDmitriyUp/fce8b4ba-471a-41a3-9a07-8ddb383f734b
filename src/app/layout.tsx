...
export const metadata: Metadata = {
  title: "F1 Racing News - Latest Formula 1 Breaking News & Updates",
  description: "Your ultimate source for Formula 1 racing news, breaking stories, race results, driver updates, team analysis, and exclusive motorsport insights.",
  keywords: "Formula 1, F1, racing news, motorsport, Grand Prix, drivers, teams, race results, championship",
  metadataBase: new URL("https://f1racingnews.com"),
  alternates: {
    canonical: "https://f1racingnews.com"
  },
  openGraph: {
    title: "F1 Racing News - Latest Formula 1 Breaking News",
    description: "Stay updated with the fastest Formula 1 news, race results, and exclusive motorsport coverage",
    url: "https://f1racingnews.com",
    siteName: "F1 Racing News",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763395411114-1tznlrgx.jpg",
      alt: "F1 Racing News"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Racing News - Latest Formula 1 Updates",
    description: "Breaking Formula 1 news, race coverage, and motorsport insights",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1763395411114-1tznlrgx.jpg"]
  },
  robots: {
    index: true,
    follow: true
